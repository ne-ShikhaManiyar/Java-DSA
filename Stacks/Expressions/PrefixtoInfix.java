    ...
    public static void main(String[] args)
    {
        ...
        for(int i = n-1; i >= 0; i--)
        {
            ...
            else
            {
                ...
                // Combine the two values and the operator to create the 
                //infix notation for the expression
                String t = "(" + v1 + op + v2 + ")";
                
                // Push the resulting value (infix notation as a string) to the value stack
                val.push(t);
            }
        }
...
which represents the infix notation
