...
public class PrefixEvaluation {
    ...
    // In prefix, we iterate in reverse to get the infix value
    // In prefix, as we iterate in reverse, we take val v1 as the first value and then value v2 as the second value
...
4. Loop through each character of the input string str from i = n-1 to i = 0 (iterate in reverse)
    ...
    d. Else (ch is an operator: +, -, *, /)
       i. Pop the top two values (v1 and v2) from the val stack
...
which represents the evaluation of the prefix expression
