    ...
    public static void main(String[] args) {
        ...
        for (int i = 0; i < n; i++) {
            ...
            if (ascii >= 48 && ascii <= 57) {
                ...
                // inside the parenthesis to prefix notation
                ...
                while (op.peek() != '(') {
                    ...
                    // Combine the two values and the operator to create the prefix notation for the expression
                    String t = o + v1 + v2;
        ...
        // Empty the remaining operators in the operator stack and convert the expressions to prefix notation
        while (val.size() > 1) {
            String v2 = val.pop();
            String v1 = val.pop();
            char o = op.pop();
        ...
        // The final result will be the only value remaining in the value stack, which represents the prefix notation
...
4. Loop through each character of the input string infix from i = 0 to i = n-1
    ...
    d. Else if the op stack is empty or ch is an opening parenthesis '(' or the top of the op stack 
    is also '('
    ...
    e. Else if ch is a closing parenthesis ')'
       i. While the top of the op stack is not an opening parenthesis '('
          ...
          C. Combine the two values and the operator to create the prefix notation for the expression
    ...
    f. Else (ch is an operator: +, -, *, /)
       ...
       ii. Else (ch is * or /)
           A. If the top of the op stack is also * or /
              ...
              iii. Combine the two values and the operator to create the prefix notation for 
              the expression
...
6. While the size of val stack is greater than 1
    ...
    c. Combine the two values and the operator to create the prefix notation for the expression
    d. Push the resulting value to the val stack
7. The final result will be the only value remaining in the val stack, which represents the
 prefix notation
