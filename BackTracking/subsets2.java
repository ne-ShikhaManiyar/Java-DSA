...
public class subsets2 {
    ...
    public static ArrayList<ArrayList<Integer>> solve(ArrayList<Integer> A) {
        ...
        subsets(result, new ArrayList<>(), A, 0);
    ...
    public static void subsets(ArrayList<ArrayList<Integer>> result, ArrayList<Integer> templist, ArrayList<Integer> A, int start) {
...
-> For each element:
-> it checks if the element is not at start suppose at 2nd or 3rd ele 
and compare i-1==i to avoid duplicates eg[1,2,2] so it wont generate duplicate subset from  level 1 and further on
